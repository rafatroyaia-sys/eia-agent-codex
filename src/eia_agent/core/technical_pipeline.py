...
Orquesta en un único flujo, en orden, todos los módulos ya construidos:
  ...
  9.  PHASE6_CUMULATIVE        — build_cumulative_synergistic_section_from_json
  10. AUDIT_ART45              — evaluate_art45_checklist_from_files
  11. AUDIT_PRUDENCE           — validate_prudence_from_files
  12. AUDIT_TRACEABILITY       — validate_traceability_from_files
  13. AUDIT_BLOCK_CONSISTENCY      — validate_block_consistency_from_files (RD-04)
  14. AUDIT_CONESA                 — validate_conesa_coverage_from_files (RD-06)
  15. AUDIT_DIAGNOSTIC_MEASURES   — validate_diagnostic_measures_from_files (RD-08)
  16. AUDIT_PRL_MEASURES          — validate_prl_measures_from_files (RD-09)
  17. AUDIT_FINAL                 — build_final_audit_from_files
...
_STEP_NAMES: dict[str, str] = {
    ...
    "AUDIT_FINAL": "Informe final de auditoria (AU-04+RD-04+RD-06+RD-08+RD-09)",
}
...
def run_technical_pipeline(
    ...
    notes = [
        "Pipeline PIPE-01+PIPE-02: no declara aptitud administrativa.",
