...
| DOC-03 | Inserción de figuras, mapas, climogramas y anexos gráficos en DOCX | P1 | M | DOC-02 | ✅ **COMPLETADO 2026-05-20** — `src/eia_agent/core/document_figure_inserter.py`. 89 tests OK. `DocumentFigure`, `FigureInsertionResult`, `detect_figure_type` (6 tipos por substring), `build_figure_title/caption`, `validate_image_file`, `discover_document_figures` (7 dirs), `add_figures_annex_to_docx`, `insert_figures_into_document`, `build_figure_result_markdown`. CLI `document-insert-figures [--write]`. Sin IA, sin web, sin PDF. Suite 5841 OK. `docs/DOCUMENT_FIGURE_INSERTER.md`. | |
