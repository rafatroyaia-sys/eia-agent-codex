...
- ~~**DOC-03**: Inserción de figuras, mapas, climogramas y anexos gráficos en DOCX~~ — **COMPLETADO ✅ 2026-05-20** (89 tests OK, `document_figure_inserter.py`, 6 tipos MAPA/CLIMOGRAMA/FOTOGRAFIA/LOGO/GRAFICO/OTRO, 7 dirs de busqueda, `discover_document_figures`, `add_figures_annex_to_docx`, `insert_figures_into_document`, CLI `document-insert-figures [--write]`, sin IA/web/PDF, suite 5841 OK, `docs/DOCUMENT_FIGURE_INSERTER.md`) (copia QA-03/NAVE-222, DOC-00 11/11 READY, DOC-01 10+1 PARTIAL borrador completo, DOC-02 DOCX 1,35 MB 305 párrafos 71 headings 6 tablas, 6/6 outputs OK, 11/11 bloques A-K en MD+DOCX, 0 bugs, suite 5752 OK, `control_interno/qa04_prueba_generacion_documental.md`)
- **IM-06** código: template C.5 en IM-01
- **IM-07** código: módulo propagación cadenas condicionales
