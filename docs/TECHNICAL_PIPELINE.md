# TECHNICAL_PIPELINE — PIPE-01 + PIPE-02
...
Tests: `tests/test_technical_pipeline.py` (72 + 6 + 11 = 89 tests)

---

## Qué hace el pipeline

Ejecuta en un único flujo, en orden, los 15 módulos técnicos ya construidos, desde el inventario ambiental (Fase 5) hasta el informe final de auditoría (AU-04 con RD-04 y RD-06).
...
| 9 | PHASE6_CUMULATIVE | `phase6-cumulative --write` | `impactos/cumulative_synergistic_result.json` |
| 10 | AUDIT_ART45 | `audit-art45 --write` | `auditoria/art45_checklist_result.json` |
| 11 | AUDIT_PRUDENCE | `audit-prudence --write` | `auditoria/prudence_validation_result.json` |
| 12 | AUDIT_TRACEABILITY | `audit-traceability --write` | `auditoria/traceability_validation_result.json` |
| 13 | AUDIT_BLOCK_CONSISTENCY | `audit-block-consistency --write` | `auditoria/block_consistency_result.json` |
| 14 | AUDIT_CONESA | `audit-conesa --write` | `auditoria/conesa_check_result.json` |
| 15 | AUDIT_DIAGNOSTIC_MEASURES | `audit-diagnostic-measures --write` | `auditoria/diagnostic_measure_validation_result.json` |
| 16 | AUDIT_PRL_MEASURES | `audit-prl-measures --write` | `auditoria/prl_measure_validation_result.json` |
| 17 | AUDIT_FINAL | `audit-final --write` | `auditoria/final_audit_result.json` |
