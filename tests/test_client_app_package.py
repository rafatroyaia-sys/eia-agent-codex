...
class TestClientAppPackage(unittest.TestCase):
    ...
    def test_new_project_app_supports_real_intake_workflow(self):
        ...
        self.assertIn("Guia rapida para el cliente", html)
        self.assertIn("Que debe aportar", html)
        self.assertIn("Que automatiza la app", html)
        self.assertIn("Que debe revisar antes de presentar", html)
        ...
        self.assertIn("Calidad de entrada", html)
        self.assertIn("Mejoras recomendadas", html)
        self.assertIn("quality_score", html)
        self.assertIn("missing_recommended_files", html)
        ...
        self.assertIn("Generar Documento Ambiental", html)
        self.assertIn("output-gallery", html)
        ...
        self.assertIn("Resultado de revision", html)
        self.assertIn("renderReviewSummary", html)
        self.assertIn("review-sections", html)
        self.assertIn("renderReviewSection", html)
        self.assertIn("review-status", html)
        self.assertIn("Documentos y paquetes generados", html)
        self.assertIn("Mapas, planos y climograma", html)
        self.assertIn("normaliseSteps", html)
        self.assertIn("estimateGenerationProgress", html)
        self.assertIn("CLIMOGRAM", html)
        self.assertIn("Mapas automaticos", html)
        self.assertIn("Planos del cliente", html)
        self.assertIn("Word editable", html)
        self.assertIn("Copia completa", html)
